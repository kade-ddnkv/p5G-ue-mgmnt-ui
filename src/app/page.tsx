      ...
      <div className="2xl:w-6/12 2xl:h-screen bg-white">
        <div className="px-20 py-10">
          ...
          <div className="flex flex-row justify-end mt-1">
            ...
            <div className='cursor-pointer hover:bg-gray-200 rounded-full h-12 w-12 bg-gray-100 flex items-center justify-center'><PlusIcon className='h-5 w-5'></PlusIcon></div>
          </div>
